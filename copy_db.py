...
Base = automap_base()
URI = 'postgresql://score:Rysherat2@shopscore.devman.org:5432/shop'
source_engine = create_engine(URI)
...
def insert_into_db():
    ...
    for order in inserted_orders:
        target_order = NewOrders(
                            ...
                            order.contact_email, order.price,
                            order.comment, order.contact_name)
